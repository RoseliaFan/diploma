...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="/img/{{'холодильник.png'}}" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="/img/{{'пылесос.png'}}" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="/img/{{'стиральная машина.png'}}" class="card-img-top" alt="...">
                <div class="card-body">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="/img/{{'микроволновка.png'}}" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="/img/{{'мультиварка.png'}}" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            <div class="card">
                <img src="/img/{{'телевизор.png'}}" class="card-img-top" alt="...">
                <div class="card-body">
